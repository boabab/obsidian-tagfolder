...
class TagFolderSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.setDesc(
				"Remove the whole note from TagFolder if it has any of these comma-separated tags. Use * for glob matching."
			)
			.addTextArea((text) =>
				text
		...
		new Setting(containerEl)
			...
			.setDesc("Remove these comma-separated tags from the generated tree, but keep each note under its remaining tags. Use * for glob matching.")
			.addTextArea((text) =>
				text
		...
		new Setting(containerEl)
			...
			.setDesc("Show notes with these comma-separated tags under the matching generated tag folder instead of their other top-level tag folders. Use * for glob matching.")
			.addTextArea((text) =>
				text
